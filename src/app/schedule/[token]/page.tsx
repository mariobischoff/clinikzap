    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-[#030712] text-slate-100 p-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-red-500/10 rounded-full blur-[100px] animate-float" />
        </div>

        <div className="relative w-full max-w-md glass-panel rounded-3xl p-8 text-center shadow-2xl z-10">
      ...
      <main className="min-h-screen flex items-center justify-center bg-[#030712] text-slate-100 p-4 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-md glass-panel rounded-3xl p-8 text-center shadow-2xl z-10">
          <div className="w-16 h-16 bg-teal-500/10 border border-teal-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
            <CalendarCheck2 className="w-8 h-8 text-teal-400 animate-bounce" />
          </div>
          ...
          <div className="bg-slate-900/60 border border-white/5 rounded-2xl p-4 text-sm text-slate-300 space-y-2 mb-6 text-left">
  ...
  if (appointment.status === 'CANCELED') {
    return (
      <main className="min-h-screen flex items-center justify-center bg-[#030712] text-slate-100 p-4 relative overflow-hidden">
        {/* Background Decorative Gradients */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-slate-500/5 rounded-full blur-[100px] animate-float" />
        </div>

        <div className="relative w-full max-w-md glass-panel rounded-3xl p-8 text-center shadow-2xl z-10">
          <div className="w-16 h-16 bg-slate-800/80 border border-white/5 rounded-full flex items-center justify-center mx-auto mb-6">
